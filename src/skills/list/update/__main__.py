...
class Update(BaseSkill):
     ...
     def execute(self, context, intent):
          ...
          if not self.slot_exists("list") and not self.slot_exists("entity") and not self.slot_exists("new_entity"):
               ...
               self.question("get.entity", self.get_entity, {
                    "list": self.get("list"), 
                    "new": self.get("new_entity")
                    })
          elif not self.slot_exists("new_entity"):
               self.question("get.new.entity", self.get_new_entity, {
                    "list": self.get("list"), 
     ...
     def update_element(self):
          ...
          if List.exist(list):
               try:
                    ...
                    self.question("did.not.found.entity", self.add_new, {
                    "list": list, 
                    "entity": entity,
                    "new": new,
     ...
     def try_to_update(self, list, entity, new):
          ...
          self.responce_translated("changed.item", {
               "entity": entity.title(), 
               "list": list.title(),
               "new": new.title()
               })
